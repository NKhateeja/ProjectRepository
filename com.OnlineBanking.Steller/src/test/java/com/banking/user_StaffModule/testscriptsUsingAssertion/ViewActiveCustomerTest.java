...
import com.onlinebanking.pom.ViewActiveAccountPage;

public class ViewActiveCustomerTest extends BaseClass {
...
//		Eut.insertDataIntoExcel("OpenAccount", 2, 19, ApplicationNo);
		...
		Reporter.log("ViewActiveCustomerTest test case is pass",true);
		sa.assertAll();
